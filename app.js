...
const UIController = (function () {
    ...
    const formatNumber = function name(num, type) {
        ...
        if (int.length > 3) {
            int = int
                .substr(0, int.length - 3) + ',' + int.substr(int.length - 3, int.length);
            // input 23510 result=> output 23,510
        }
    ...
    return {
        ...
        addListItem: function (obj, type) {
            ...
            // Creatae HTML string with placeholder text
            if (type === 'inc') {
